define(function (require) {
    ...
    var $                   = require('jquery'),
        ...
        Contest = Backbone.DeepModel.extend({

            idAttribute: '_id',

            urlRoot: Credentials.server_root + "contest/",
    ...
    Contest = Backbone.UniqueModel(Contest);

    var ContestCollection = Backbone.Paginator.requestPager.extend({
