define(function (require) {
    ...
    var $                   = require('jquery'),
        ...
        ContestVote = Backbone.DeepModel.extend({

            idAttribute: '_id',

            urlRoot: Credentials.server_root + "contest/vote/",
    ...
    ContestVote = Backbone.UniqueModel(ContestVote);

    var ContestVoteCollection = Backbone.Paginator.requestPager.extend({

            model: ContestVote,

            // url: Credentials.server_root + "contests/by_players",
            urlRoot: Credentials.server_root + "contests/",
            ...
            findByLastContestVote: function(){
    ...
    return {
        ...
        ContestVoteCollection: ContestVoteCollection
    };
