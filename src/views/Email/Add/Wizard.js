define(function(require, exports, module) {
    ...
    function PageView(options) {
        ...
        if(App.Cache.EmailAddOptions){
            this.cacheOptions = App.Cache.EmailAddOptions;
        ...
        this.wizardPaths = {
            ...
            'detail': {
                    cacheOptions: 'EmailAddDetailOptions',
                    route: 'email/add/detail',
                    summaryPath: 'detail'
                },

            // 'payment' : {
            //         cacheOptions: 'EmailAddPaymentOptions',
            //         title: 'Payment',
            //         route: 'email/add/payment', // should pass the event_id as well?
            //         summaryPath: 'payment'
            //     },

            // 'players' : {
            //         cacheOptions: 'EmailAddPlayersOptions',
            //         title: 'Players',
            //         route: 'email/add/player', // should pass the event_id as well?
            //         summaryPath: 'player_results'
            //     },
            // 'result' : {
            //         cacheOptions: 'EmailAddResultOptions',
            //         title: 'Result',
            //         route: 'email/add/result',
        ...
        this.wizardSummaryPath = '/email/add/summary';
    ...
    PageView.prototype.complete = function(ev){
        ...
        this.model.save()
            .then(function(newModel){
                ...
                // Created OK
                Utils.Notification.Toast('Email Created!');
    ...
    PageView.prototype.summary_page = function(){
        ...
        App.Cache.EmailAddSummaryOptions = {
