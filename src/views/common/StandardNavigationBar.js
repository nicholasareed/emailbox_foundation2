...
define(function(require, exports, module) {
    ...
    function NavigationBar(options) {
        ...
        this.back = new Surface({
            ...
            classes: this.options.backClasses ? this.options.backClasses : this.options.classes,
        ...
        this.more = new Surface({
            size: [this.options.size[1], this.options.size[1]],
            classes: this.options.moreClasses ? this.options.moreClasses : this.options.classes,
        ...
        this._optionsManager.on('change', function(event) {
            ...
            if (key === 'size') {
                ...
                this.back.setOptions({classes: this.options.backClasses});
            }
                ...
                this.back.setOptions({classes: this.options.backClasses ? this.options.backClasses : this.options.classes});
                this.more.setOptions({classes: this.options.moreClasses ? this.options.moreClasses : this.options.classes});
            }
            else if (key === 'content') {
                this.setContent(this.options.content);
            }
            else if (key === 'moreClasses') {
                this.more.setOptions({classes: this.options.moreClasses});
            }
